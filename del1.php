...
<html>
  ...
  <h3 style="color:black"><b>Welcome 
    ...
    <center><h2 style="font-size:60px"><font color="black"> Delete Teacher's Record</font></h2></center>
   </div>
...
if(isset($_POST['logout']))
   ...
   ?>
   <br><br><br><br><br>
 <form class="myform" action="del1.php" method="post">
 <p class="er">
...
{
	$query="delete from teacher_info where T_id='$tid'";
if(mysqli_query($con,$query))
{
	echo "<script>alert('Teacher record deleted successfully')</script>";
