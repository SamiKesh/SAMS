...
<html>
  ...
  <h3 style="color:black"><b>Welcome 
    ...
    <center><h2 style="font-size:70px"><font color="black">Delete Student's Record</font></h2></center>
   </div>
...
if(isset($_POST['logout']))
   ...
   ?>
   <br><br><br>
 <form class="myform" action="del3.php" method="post">
 <p class="er">
...
{
	$query="delete from student_info where examrollno='$sid'";
if(mysqli_query($con,$query))
{
	...
	echo "<script>alert('No Such Student's record exists!!')</script>";
}
}
?>
</html>