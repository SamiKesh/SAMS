...
<label for="T_id"><font color="red">SEARCH HERE....</font></label><br>
   <p class="field">
   <input style="width:400px;height:25px;" name="T_id" type="text" id="T_id" placeholder="Enter the TEACHER'S ID"><br>
   </p>
   <br>
   <p class="Go">
