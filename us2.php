...
<html>
  ...
  <h3 style="color:black"><b>Welcome 
    ...
    <center><h2 style="font-size:63px"><font color="black">Update Subject's Record</font></h2></center>
   <br>
   </div>
...
if(isset($_POST['logout']))
   ...
   ?>
   <br><br><br><br>
 <form class="myform" action="us2.php" method="post">
 <p class="er">
...
{
	$_SESSION['sub_id']=$sid;
header('location:us22.php');
}
else
	echo "<script>alert('No Such  Subject's record exists!!')</script>";
